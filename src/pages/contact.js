            ...
            <div className="border-t border-slate-300 flex flex-wrap lg:flex-nowrap lg:mt-4 mx-8 lg:mx-0 pb-16 pt-9 lg:py-12">
                ...
                <div className="w-full lg:w-2/3">
                    <form>
                        ...
                        <div>
                            <button className="relative bg-slate-800 hover:bg-neutral-900 h-12 font-semibold inline-block pl-12 text-white text-xs tracking-widest uppercase w-[200px]" type="submit">
