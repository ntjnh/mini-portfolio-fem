        ...
        <Layout>
            <section className="home-hero md:aspect-[7/6] lg:aspect-[37/20] bg-cover bg-center bg-no-repeat mb-20 lg:mb-36 md:relative w-full" style={heroBg}>
                <div className="md:absolute md:bg-white bottom-0 md:pb-24 px-8 pt-4 md:pt-12 md:w-3/4 lg:w-[41%]">
                    ...
                    <a className="relative md:absolute bg-slate-800 hover:bg-neutral-900 md:bottom-0 h-12 font-semibold inline-block leading-12 left-0 pl-12 text-center text-slate-50 text-xs tracking-widest uppercase w-[200px]" href="#about">
            ...
            <section className="flex flex-wrap md:flex-nowrap justify-between px-8 md:px-0">
                <div className="lg:pr-4 md:w-2/5 lg:w-1/2">
                    <img className="max-w-full mb-8 md:mb-0 md:aspect-[7/15] lg:aspect-auto object-cover" src={natePhoto} alt="Nate" />
                </div>

                <article className="w-full md:w-3/5 lg:w-1/2" id="about">
                    <div className="border-y border-slate-300 md:h-full md:max-w-[350px] md:ml-auto lg:mx-auto pb-12 md:pb-10 pt-9 md:pt-12">
